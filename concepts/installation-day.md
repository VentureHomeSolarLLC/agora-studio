...
1. **Municipal inspection** — local authority verifies installation meets code
2. **Permission to Operate (PTO)** — utility company approval to connect to grid
